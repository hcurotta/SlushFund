...
class FundsControllerTest < ActionController::TestCase
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post :create, fund: { budget: @fund.budget, description: @fund.description, name: @fund.name, party_time: @fund.party_time, user_id: @fund.user_id }
    end
  ...
  test "should update fund" do
    put :update, id: @fund, fund: { budget: @fund.budget, description: @fund.description, name: @fund.name, party_time: @fund.party_time, user_id: @fund.user_id }
    assert_redirected_to fund_path(assigns(:fund))
  end
